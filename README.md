# 10 Object-Oriented Programming: TeamBio
...
![Video to show functioning.] TeamBio\Team Profile.webm
TeamBio\Team Profile Demo Video.webm

(Both mock-up image/video are in the files that can be seen under repo files.)
